    ...
    return (
      <Card 
        ...
        sx={{ 
          ...
          cursor: 'pointer',
          borderRadius: 3,
          background: 'linear-gradient(135deg, #e8f4fd 0%, #c3e0f7 100%)',
      ...
      >
        ...
        <CardContent sx={{ flexGrow: 1, p: 3 }}>
          ...
          {(user.subjectsToTeach?.length > 0 || user.commonSubjects?.theyTeach?.length > 0) && (
            <Box mb={2}>
              <Typography variant="subtitle2" sx={{ color: '#2e7d32', fontWeight: 'bold', mb: 1 }}>Can teach you:</Typography>
          ...
          {(user.subjectsToLearn?.length > 0 || user.commonSubjects?.theyLearn?.length > 0) && (
            <Box mb={2}>
              <Typography variant="subtitle2" sx={{ color: '#d32f2f', fontWeight: 'bold', mb: 1 }}>You can teach:</Typography>
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
